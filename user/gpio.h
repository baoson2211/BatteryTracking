...
#define SET_LED13     { GPIO_SetBits(GPIOD, GPIO_Pin_9 ); }//2
#define SET_LED02     { GPIO_SetBits(GPIOD, GPIO_Pin_11); }//3
#define SET_LED14     { GPIO_SetBits(GPIOD, GPIO_Pin_13); }//4
#define SET_LED03     { GPIO_SetBits(GPIOD, GPIO_Pin_15); }//5
#define SET_LED15     { GPIO_SetBits(GPIOG, GPIO_Pin_3 ); }//6
#define SET_LED04     { GPIO_SetBits(GPIOG, GPIO_Pin_5 ); }//7
#define SET_LED16     { GPIO_SetBits(GPIOG, GPIO_Pin_7 ); }//8
#define SET_LED05     { GPIO_SetBits(GPIOC, GPIO_Pin_6 ); }//9
#define SET_LED17     { GPIO_SetBits(GPIOC, GPIO_Pin_8 ); }//10
#define SET_LED06     { GPIO_SetBits(GPIOA, GPIO_Pin_8 ); }//11
#define SET_LED18     { GPIO_SetBits(GPIOA, GPIO_Pin_10); }//12
#define SET_LED07     { GPIO_SetBits(GPIOA, GPIO_Pin_12); }//13
#define SET_LED19     { GPIO_SetBits(GPIOA, GPIO_Pin_14); }//14
#define SET_LED08     { GPIO_SetBits(GPIOC, GPIO_Pin_10); }//15
#define SET_LED20     { GPIO_SetBits(GPIOC, GPIO_Pin_12); }//16
#define SET_LED09     { GPIO_SetBits(GPIOD, GPIO_Pin_1 ); }//17
#define SET_LED21     { GPIO_SetBits(GPIOD, GPIO_Pin_3 ); }//18
#define SET_LED10     { GPIO_SetBits(GPIOD, GPIO_Pin_5 ); }//19
#define SET_LED22     { GPIO_SetBits(GPIOD, GPIO_Pin_7 ); }//20
#define SET_LED11     { GPIO_SetBits(GPIOG, GPIO_Pin_10); }//21
#define SET_LED23     { GPIO_SetBits(GPIOG, GPIO_Pin_12); }//22
#define SET_LED12     { GPIO_SetBits(GPIOG, GPIO_Pin_14); }//23
#define SET_LED24     { GPIO_SetBits(GPIOB, GPIO_Pin_3 ); }//24
...
#define RESET_LED17   { GPIO_ResetBits(GPIOC, GPIO_Pin_8 ); }//10
...
#define RESET_LED19   { GPIO_ResetBits(GPIOA, GPIO_Pin_14); }//14
#define RESET_LED08   { GPIO_ResetBits(GPIOC, GPIO_Pin_10); }//15
#define RESET_LED20   { GPIO_ResetBits(GPIOC, GPIO_Pin_12); }//16
...
#define RESET_LED24   { GPIO_ResetBits(GPIOB, GPIO_Pin_3 ); }//24
